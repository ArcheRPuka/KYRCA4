...
//	cord[1] = { x + 25,y - 35,50,50 };
//	cord[2] = { x + 25,y - 25,50,50 };
//	cord[3] = { x + 25,y - 15,50,50 };
//	switch (a)
//	{
//	case(0):
//	{
...
//	for (int i = 0; i < 10; i++)
//	{
//		Player_res[i].gold = 100;
//		Player_res[i].eat = 100;
//		Player_res[i].metl = 100;
//	}
//	//массив построек////////////////////////////////////////////
...
//								{
//									Player_voin_map[0][close].bronz = coinvoin[1];
...
//								{
//									Player_voin_map[0][close].serebr = coinvoin[2];
...
//								{
//									Player_voin_map[0][close].gold = coinvoin[3];
...
//								if (coinvoin[1] == 0)
//								{
//									Menu_obchenia(renderer, 7, Player_st[close].market, Player_st[close].kazarm, Player_st[close].krepoct, Player_st[close].mine);
//								}
//								if (coinvoin[2] == 0)
//								{
